...
bool AuthSocket::_HandleLogonChallenge()
{
    ...
    _build = ch->build;
    _expversion = (AuthHelper::IsPostCataclysmAcceptedClientBuild(_build) ? POST_CATACLYSM_EXP_FLAG : NO_VALID_EXP_FLAG) | (AuthHelper::IsPostWotLKAcceptedClientBuild(_build) ? POST_WOTLK_EXP_FLAG : NO_VALID_EXP_FLAG) | (AuthHelper::IsPostBCAcceptedClientBuild(_build) ? POST_BC_EXP_FLAG : NO_VALID_EXP_FLAG) | (AuthHelper::IsPreBCAcceptedClientBuild(_build) ? PRE_BC_EXP_FLAG : NO_VALID_EXP_FLAG);
